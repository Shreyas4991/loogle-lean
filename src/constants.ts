export const insertButtonToolTip = 'Insert the term at the cursor location';
export const copyButtonToolTip = 'Copy the term to the clipboard';
export const docButtonToolTip = 'Open the docs page of the definition';
export const hitMenuTitle = "Loogle Hits Found";
export const hitMenuSingularTitle = "Loogle Hit Found";
